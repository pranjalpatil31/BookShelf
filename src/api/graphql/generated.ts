...
export function useListBooksQuery(
  baseOptions?: Apollo.QueryHookOptions<
    Types.ListBooksQuery,
    Types.ListBooksQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<Types.ListBooksQuery, Types.ListBooksQueryVariables>(
    ListBooksDocument,
    options,
  );
}
export function useListBooksLazyQuery(
  ...
  return Apollo.useLazyQuery<
    Types.ListBooksQuery,
    Types.ListBooksQueryVariables
  >(ListBooksDocument, options);
}
// @ts-ignore
export function useListBooksSuspenseQuery(
...
export function useListBooksSuspenseQuery(
  ...
  Types.ListBooksQuery | undefined,
  Types.ListBooksQueryVariables
>;
export function useListBooksSuspenseQuery(
  baseOptions?:
...
>;
export type ListBooksSuspenseQueryHookResult = ReturnType<
  typeof useListBooksSuspenseQuery
>;
...
export function useSearchGoogleBooksQuery(
  baseOptions: Apollo.QueryHookOptions<
    Types.SearchGoogleBooksQuery,
    Types.SearchGoogleBooksQueryVariables
  > &
    (
      | { variables: Types.SearchGoogleBooksQueryVariables; skip?: boolean }
      | { skip: boolean }
    ),
) {
  const options = { ...defaultOptions, ...baseOptions };
...
// @ts-ignore
export function useSearchGoogleBooksSuspenseQuery(
  baseOptions?: Apollo.SuspenseQueryHookOptions<
    Types.SearchGoogleBooksQuery,
    Types.SearchGoogleBooksQueryVariables
  >,
...
export function useSearchGoogleBooksSuspenseQuery(
  ...
  Types.SearchGoogleBooksQuery | undefined,
  Types.SearchGoogleBooksQueryVariables
>;
export function useSearchGoogleBooksSuspenseQuery(
  baseOptions?:
...
>;
export type SearchGoogleBooksSuspenseQueryHookResult = ReturnType<
  typeof useSearchGoogleBooksSuspenseQuery
>;
